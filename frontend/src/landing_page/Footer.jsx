...
const Footer = () => {
  return (
    <>
      {/* <footer style={{ backgroundColor: "#efeaeA" }}> */}
      <div className="border-bottom mt-5 mb-2"></div>
      <div className="container ">
        <div className="row mb-5">
          <div className="col">
            <img style={{ width: "8rem" }} src="media/images/logo.svg" />
